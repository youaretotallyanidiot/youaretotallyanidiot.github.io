...
function openWindow() {
	window.open("idiot/index.html", "_blank", "resizable=no,width=400,height=300,top=" + randomRange(0, screen.width).toString() + ',left=' + randomRange(0, screen.height).toString());
}
